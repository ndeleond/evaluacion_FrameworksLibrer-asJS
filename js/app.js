    ...
    var intervalo=0;  //variable tiempo para funcion de desplazamiento
    var eliminar=0;   //variable tiempo para eliminar dulces
    var newdulces=0;  //variable tiempo para nuevos dulces
    var tiempo=0;     //variable tiempo para temporizador
